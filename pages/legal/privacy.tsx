...
export default function privacy() {
    return (
        <Layout title="Privacy Policy | SlicedAdvice">
            <div className="flex flex-col gap-4 px-8 py-4 lg:py-8">
                <h2 className="text-5xl font-bold tracking-tight text-brand-primary-light mb-8">Privacy Policy</h2>
                <p>
                    Your privacy is important to us. It is SlicedAdvice&#39;s
                    ...
                    website,{" "}
                    <a href="https://slicedadvice.com">
                        https://slicedadvice.com
                    </a>
                    , and other sites we own and operate.{" "}
                </p>
                <p>
                    This policy is effective as of 8 August 2022 and was last
                ...
                <p>
                    ...
                    participating in any of our services and promotions, and any
                ...
                <h2 className="text-3xl font-bold">Collection and Use of Information</h2>
                <p>
                ...
                <ul>
                    <li>
                        Enter any of our competitions, contests, sweepstakes,
                        and surveys
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        to enable you to customise or personalise your
                    ...
                    <li>
                        ...
                        website, associated applications, and associated social
                        media platforms
                    </li>
                    <li>
                    ...
                    <li>
                        to run competitions, sweepstakes, and/or offer
                        additional benefits to you
                    </li>
                </ul>
                <p>
                    Please be aware that we may combine information we collect
                    about you with general information or research data we
                ...
                <h2 className="text-3xl font-bold">Disclosure of Personal Information to Third Parties</h2>
                <p>We may disclose personal information to: </p>
                <ul>
                    <li>a parent, subsidiary, or affiliate of our company</li>
                    <li>
                        third party service providers for the purpose of
                        enabling them to provide their services, for example, IT
                        service providers, data storage, hosting and server
                    ...
                    <li>
                        sponsors or promoters of any competition, sweepstakes,
                        or promotion we run
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        or direct marketing to you third parties to collect and
                        process data
                    </li>
                </ul>
                <h2 className="text-3xl font-bold">International Transfers of Personal Information</h2>
                <p>
                    ...
                    that the locations to which we store, process, or transfer
                    your personal information may not have the same data
                    protection laws as the country in which you initially
                    provided the information. If we transfer your personal
                ...
                <h2 className="text-3xl font-bold">Your Rights and Controlling Your Personal Information</h2>
                <p>
                ...
                <h2 className="text-3xl font-bold">Use of Cookies</h2>
                <p>
                    We use &ldquo;cookies&rdquo; to collect information about
                    you and your activity across our site. A cookie is a small
                    piece of data that our website stores on your computer, and
                    accesses each time you visit, so we can understand how you
                    use our site. This helps us serve you content based on
                    preferences you have specified.{" "}
                </p>
                <h2 className="text-3xl font-bold">Limits of Our Policy</h2>
                <p>
