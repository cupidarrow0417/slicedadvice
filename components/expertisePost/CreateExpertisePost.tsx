...
const CreateExpertisePost = () => {
    ...
    // The current user is needed to check for charges enabled, as well as
    // to be passed into the created expertise post eventually as a field.
            ...
            >
                <div className="flex flex-col items-start gap-5 px-4 py-4 max-w-2xl lg:max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        { createExpertisePostLoading ? <ButtonLoader /> : "Create Post"}
                    </button>
                </div>
            </form>
        </div>
