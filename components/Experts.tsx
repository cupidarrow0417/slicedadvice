                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-4 text-lg text-gray-500">
                                        ...
                                        <span className="line-through">
                                            Building and teaching an entire
                                            course. Creating and running a viral
                                            social media page. Long consulting
                                            meetings. Tedious freelance
                                            projects.
                                        </span>{" "}
                                        It should be as easy as concisely
                                        answering a single important, impactful
                                        question using your unique experience
                                        and knowledge.
                                    </p>
                                    <div className="mt-6">
                                        <a
                        ...
                        <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
                            <div>
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-4 text-lg text-gray-500">
                                        An expertise post is a beautiful,
                                        convenient way to offer your valuable
                                        experience and knowledge to the world.
                                        You set your own prices. Create multiple
                                        posts for all of the different areas of
                                        your expertise.
                                    </p>
                                    {/* <div className="mt-6">
                                        <a
                            ...
                            <div>
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-4 text-lg text-gray-500">
                                        ...
                                        all. The moment an advice seeker books
                                        you for advice, you receive a
                                        notification to answer their question.
                            ...
                            <div>
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-4 text-lg text-gray-500">
                                        ...
                                        offer fast, secure payments to your bank
                                        account. You can be rest assured that
                                        payouts will be securely routed the
                                        moment you complete an advice booking.
                                    </p>
                                    {/* <div className="mt-6">
                                        <a
                                            href="#"
