 ...
 */
export const allExpertisePostsReducer = (state={expertisePosts: [] }, action: any) => {
    switch (action.type) {
        case ALL_EXPERTISE_POSTS_SUCCESS:
            return {
                expertisePostsCount: action.payload.expertisePostsCount,
                resPerPage: action.payload.resPerPage,
                filteredExpertisePostsCount: action.payload.filteredExpertisePostsCount,
 ...
 */
export const expertisePostDetailsReducer = (state={expertisePost: [] }, action: any) => {
    switch (action.type) {
